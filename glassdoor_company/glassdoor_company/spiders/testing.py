...
# from glass_server.items import GlassDoorItem
...
class GlassDoorSpider(scrapy.Spider):
    ...
    def start_requests(self):
        countries = [{'name': 'Oregon', 'id': 3163},{'name': 'Wisconsin', 'id': 481},{'name': 'South Carolina', 'id': 3411},{'name': 'Utah', 'id': 255},{'name': 'Connecticut', 'id': 2697}]
