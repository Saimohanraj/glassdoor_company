...
class GlassDoorSpider(scrapy.Spider):
    name = "glassdoor_company_instance_two"
    custom_settings = {
    ...
    def start_requests(self):
        countries = [{'name': 'California', 'id': 2280}, {'name': 'Texas', 'id': 1347}, {'name': 'Florida', 'id': 3318}, {'name': 'New York State', 'id': 428}, {'name': 'Pennsylvania', 'id': 3185}, {'name': 'Ohio', 'id': 2235}, {'name': 'Illinois', 'id': 302}, {'name': 'Virginia', 'id': 323}, {'name': 'North Carolina', 'id': 1282}, {'name': 'Massachusetts', 'id': 3399}, {'name': 'Georgia', 'id': 3426}, {'name': 'Michigan', 'id': 527}, {'name': 'New Jersey', 'id': 39}, {'name': 'Washington', 'id': 3020}, {'name': 'Colorado', 'id': 2519}, {'name': 'District of Columbia', 'id': 1211}, {'name': 'Arizona', 'id': 483}, {'name': 'Maryland', 'id': 3201}, {'name': 'Wisconsin', 'id': 481}, {'name': 'Indiana', 'id': 2124}, {'name': 'Tennessee', 'id': 1968}, {'name': 'Missouri', 'id': 386}, {'name': 'Minnesota', 'id': 1775}, {'name': 'South Carolina', 'id': 3411}, {'name': 'Oregon', 'id': 3163}, {'name': 'Alabama', 'id': 105}, {'name': 'Connecticut', 'id': 2697}, {'name': 'Kentucky', 'id': 1141}, {'name': 'Iowa', 'id': 2733}, {'name': 'Kansas', 'id': 3107}, {'name': 'Oklahoma', 'id': 847}, {'name': 'Louisiana', 'id': 2792}, {'name': 'Utah', 'id': 255}, {'name': 'Nevada', 'id': 2756}, {'name': 'Nebraska', 'id': 792}, {'name': 'New Hampshire', 'id': 2403}, {'name': 'New Mexico', 'id': 4488}, {'name': 'Arkansas', 'id': 6847}, {'name': 'Idaho', 'id': 5583}, {'name': 'Maine', 'id': 4698}, {'name': 'Hawaii', 'id': 1385}, {'name': 'Mississippi', 'id': 1553}, {'name': 'Montana', 'id': 669}, {'name': 'West Virginia', 'id': 1939}, {'name': 'Rhode Island', 'id': 3156}, {'name': 'North Dakota', 'id': 3517}, {'name': 'South Dakota', 'id': 1502}, {'name': 'Alaska', 'id': 496}, {'name': 'Vermont', 'id': 1765}, {'name': 'Delaware', 'id': 3523}, {'name': 'Wyoming', 'id': 1258}]
        ...
        if number_of_records !=0:
            if number_of_records<10000:
                ...
                for rate in rating_ranges:
                    ...
                    rate_min= rate['min']
                    url = "https://www.glassdoor.com/graph"
                    payload = json.dumps([{"operationName": "ExplorerEmployerSearchGraphQuery","variables": {"employerSearchRangeFilters": [{"filterType": "RATING_OVERALL","maxInclusive": 5,"minInclusive": 0},{"filterType": "EMPLOYEES_COUNT","maxInclusive": rate_max,"minInclusive": rate_min}],"industries": [{"id": id_categories}],"jobTitle": "","location": {"locationId": country,"locationType": "S"},"pageRequested": 1,"preferredTldId": 1,"sGocIds": [],"sectors": []},"query": "query ExplorerEmployerSearchGraphQuery($employerSearchRangeFilters: [EmployerSearchRangeFilter], $industries: [IndustryIdent], $jobTitle: String, $location: UgcSearchV2LocationIdent, $pageRequested: Int, $preferredTldId: Int, $sGocIds: [Int], $sectors: [SectorIdent]) {\n  employerSearchV2(\n    employerSearchRangeFilters: $employerSearchRangeFilters\n    industries: $industries\n    jobTitle: $jobTitle\n    location: $location\n    pageRequested: $pageRequested\n    preferredTldId: $preferredTldId\n    sGocIds: $sGocIds\n    sectors: $sectors\n  ) {\n    employerResults {\n      demographicRatings {\n        category\n        categoryRatings {\n          categoryValue\n          ratings {\n            overallRating\n            __typename\n          }\n          __typename\n        }\n        __typename\n      }\n      employer {\n        bestProfile {\n          id\n          __typename\n        }\n        id\n        shortName\n        ratings {\n          overallRating\n          careerOpportunitiesRating\n          compensationAndBenefitsRating\n          cultureAndValuesRating\n          diversityAndInclusionRating\n          seniorManagementRating\n          workLifeBalanceRating\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    numOfPagesAvailable\n    numOfRecordsAvailable\n    __typename\n  }\n}\n"}])
    ...
    def parse_industry_pagination(self, response,id_categories,industry,rate_max,rate_min,country):
        with open('test_2.html','w') as f: f.write(response.text)
        json_data = json.loads(response.text)
        number_of_records = json_data[0]['data']['employerSearchV2']['numOfRecordsAvailable']
        numOfPagesAvailable = json_data[0]['data']['employerSearchV2']['numOfPagesAvailable']
        for pagination in range(1, int(numOfPagesAvailable)+1):
            url = "https://www.glassdoor.com/graph"
            payload = json.dumps([{"operationName": "ExplorerEmployerSearchGraphQuery","variables": {"employerSearchRangeFilters": [{"filterType": "RATING_OVERALL","maxInclusive": 5,"minInclusive": 0},{"filterType": "EMPLOYEES_COUNT","maxInclusive": rate_max,"minInclusive": rate_min}],"industries": [{"id": id_categories}],"jobTitle": "","location": {"locationId": country,"locationType": "S"},"pageRequested": pagination,"preferredTldId": 1,"sGocIds": [],"sectors": []},"query": "query ExplorerEmployerSearchGraphQuery($employerSearchRangeFilters: [EmployerSearchRangeFilter], $industries: [IndustryIdent], $jobTitle: String, $location: UgcSearchV2LocationIdent, $pageRequested: Int, $preferredTldId: Int, $sGocIds: [Int], $sectors: [SectorIdent]) {\n  employerSearchV2(\n    employerSearchRangeFilters: $employerSearchRangeFilters\n    industries: $industries\n    jobTitle: $jobTitle\n    location: $location\n    pageRequested: $pageRequested\n    preferredTldId: $preferredTldId\n    sGocIds: $sGocIds\n    sectors: $sectors\n  ) {\n    employerResults {\n      demographicRatings {\n        category\n        categoryRatings {\n          categoryValue\n          ratings {\n            overallRating\n            __typename\n          }\n          __typename\n        }\n        __typename\n      }\n      employer {\n        bestProfile {\n          id\n          __typename\n        }\n        id\n        shortName\n        ratings {\n          overallRating\n          careerOpportunitiesRating\n          compensationAndBenefitsRating\n          cultureAndValuesRating\n          diversityAndInclusionRating\n          seniorManagementRating\n          workLifeBalanceRating\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    numOfPagesAvailable\n    numOfRecordsAvailable\n    __typename\n  }\n}\n"}])
            yield scrapy.Request(url, method="POST", body=payload, headers=self.headers, callback=self.parse_detail_collection,dont_filter=True,cb_kwargs={'industry':industry,'id_categories':id_categories,'rate_max':rate_max,'rate_min':rate_min,'country':country})

    def parse_else_part(self, response,id_categories,industry,rate_max,rate_min,country):
        with open('test_3.html','w') as f: f.write(response.text)
        json_data = json.loads(response.text)
        number_of_records = json_data[0]['data']['employerSearchV2']['numOfRecordsAvailable']
        numOfPagesAvailable = json_data[0]['data']['employerSearchV2']['numOfPagesAvailable']
        if number_of_records <10000:
            ...
            for rate in rating_ranges:
                ...
                rate_min= rate['min']
                url = "https://www.glassdoor.com/graph"
                payload = json.dumps([{"operationName": "ExplorerEmployerSearchGraphQuery","variables": {"employerSearchRangeFilters": [{"filterType": "RATING_OVERALL","maxInclusive": 5,"minInclusive": 0},{"filterType": "EMPLOYEES_COUNT","maxInclusive": rate_max,"minInclusive": rate_min}],"industries": [],"jobTitle": "","location": {"locationId": country,"locationType": "S"},"pageRequested": 1,"preferredTldId": 1,"sGocIds": [],"sectors": [{"id": id_categories}]},"query": "query ExplorerEmployerSearchGraphQuery($employerSearchRangeFilters: [EmployerSearchRangeFilter], $industries: [IndustryIdent], $jobTitle: String, $location: UgcSearchV2LocationIdent, $pageRequested: Int, $preferredTldId: Int, $sGocIds: [Int], $sectors: [SectorIdent]) {\n  employerSearchV2(\n    employerSearchRangeFilters: $employerSearchRangeFilters\n    industries: $industries\n    jobTitle: $jobTitle\n    location: $location\n    pageRequested: $pageRequested\n    preferredTldId: $preferredTldId\n    sGocIds: $sGocIds\n    sectors: $sectors\n  ) {\n    employerResults {\n      demographicRatings {\n        category\n        categoryRatings {\n          categoryValue\n          ratings {\n            overallRating\n            __typename\n          }\n          __typename\n        }\n        __typename\n      }\n      employer {\n        bestProfile {\n          id\n          __typename\n        }\n        id\n        shortName\n        ratings {\n          overallRating\n          careerOpportunitiesRating\n          compensationAndBenefitsRating\n          cultureAndValuesRating\n          diversityAndInclusionRating\n          seniorManagementRating\n          workLifeBalanceRating\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    numOfPagesAvailable\n    numOfRecordsAvailable\n    __typename\n  }\n}\n"}])
    ...
    def parse_sector_filter(self, response,id_categories,industry,rate_max,rate_min,country):
        with open('test_4.html','w') as f: f.write(response.text)
        json_data = json.loads(response.text)
        number_of_records = json_data[0]['data']['employerSearchV2']['numOfRecordsAvailable']
        numOfPagesAvailable = json_data[0]['data']['employerSearchV2']['numOfPagesAvailable']
        for pagination in range(1, int(numOfPagesAvailable)+1):
            url = "https://www.glassdoor.com/graph"
            payload = json.dumps([{"operationName": "ExplorerEmployerSearchGraphQuery","variables": {"employerSearchRangeFilters": [{"filterType": "RATING_OVERALL","maxInclusive": 5,"minInclusive": 0},{"filterType": "EMPLOYEES_COUNT","maxInclusive": rate_max,"minInclusive": rate_min}],"industries": [],"jobTitle": "","location": {"locationId": country,"locationType": "S"},"pageRequested": pagination,"preferredTldId": 1,"sGocIds": [],"sectors": [{"id": id_categories}]},"query": "query ExplorerEmployerSearchGraphQuery($employerSearchRangeFilters: [EmployerSearchRangeFilter], $industries: [IndustryIdent], $jobTitle: String, $location: UgcSearchV2LocationIdent, $pageRequested: Int, $preferredTldId: Int, $sGocIds: [Int], $sectors: [SectorIdent]) {\n  employerSearchV2(\n    employerSearchRangeFilters: $employerSearchRangeFilters\n    industries: $industries\n    jobTitle: $jobTitle\n    location: $location\n    pageRequested: $pageRequested\n    preferredTldId: $preferredTldId\n    sGocIds: $sGocIds\n    sectors: $sectors\n  ) {\n    employerResults {\n      demographicRatings {\n        category\n        categoryRatings {\n          categoryValue\n          ratings {\n            overallRating\n            __typename\n          }\n          __typename\n        }\n        __typename\n      }\n      employer {\n        bestProfile {\n          id\n          __typename\n        }\n        id\n        shortName\n        ratings {\n          overallRating\n          careerOpportunitiesRating\n          compensationAndBenefitsRating\n          cultureAndValuesRating\n          diversityAndInclusionRating\n          seniorManagementRating\n          workLifeBalanceRating\n          __typename\n        }\n        __typename\n      }\n      __typename\n    }\n    numOfPagesAvailable\n    numOfRecordsAvailable\n    __typename\n  }\n}\n"}])
            yield scrapy.Request(url, method="POST", body=payload, headers=self.headers, callback=self.parse_detail_collection,dont_filter=True,cb_kwargs={'industry':industry,'id_categories':id_categories,'rate_max':rate_max,'rate_min':rate_min,'country':country})
    ...
    def parse_employer_details(self, response,industry,id_categories,rate_max,rate_min,country):
        with open('test_5.html','w') as f: f.write(response.text)
        employer_detail = json.loads(response.text)
        breakpoint()
        employ = employer_detail[0]['data']
        item = GlassDoorItem()
        # if employ['EmployerReviews']['ratings']['cultureAndValuesRating'] == -1:
        #     breakpoint()
        ...
        item['company_name'] = employ['EmployerReviews']['employer']['shortName']
